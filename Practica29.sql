...
fecha_nac DATE ,
id_equipo NUMBER(2) CONSTRAINT juadores_fk REFERENCES equipos(id_equipo) ON DELETE SET NULL
);
...
ALTER TABLE jugadores RENAME CONSTRAINT equipos_nn TO jugadores_nn ;
